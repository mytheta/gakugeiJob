<tiles:insert template="/WEB-INF/view/common/school/layout.jsp" flush="true">
	...
	<tiles:put name="content" type="string">
		<div class="jumbotron text-center" style="background-color:#FFE;coror:#000">
 	 	...
 	 	<h2 class="text-center page-header">他者求人情報</h2>
		...
		<div class="text-right">
			<form name="viewOtherOfferActionForm" class="form-horizontal" action="/gakugeiJob/school/viewOtherOffer/" method="POST">
