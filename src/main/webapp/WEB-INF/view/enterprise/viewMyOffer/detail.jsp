	...
	<tiles:put name="content" type="string">
 	...
 	<c:forEach items="${enterpriseList}" var="enterprise">		
 	 	...
 	 	<div class="container">	
			...
			<div class="col-sm-offset-2 col-sm-8 col-sm-offset-2">
 	 		<font size="4"><p class="text-left">&nbsp;&nbsp;経験資格:</p></font>
				<pre><c:out value="${enterpriseOffer.qualification}" /></pre>
			</div>
			...
			<input type="hidden" value="${enterpriseOffer.jobOfferId}" name="jobOfferId"/>
				<a href="/gakugeiJob/enterprise/editOffer/"><button class="btn btn-lg btn-success">編集</button></a>
			</form>
			</div>
