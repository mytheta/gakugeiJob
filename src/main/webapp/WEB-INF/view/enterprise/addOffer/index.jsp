<tiles:insert template="/WEB-INF/view/common/enterprise/layout.jsp" flush="true">
	...
	<tiles:put name="content" type="string">
		<div class="jumbotron text-center" style="background-color:#FFE;color:#000">	
 	 	...
 	 	<div class="container">
 	 	<h1 class="page-header">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<small>登録情報（●印は入力必須項目）<br>入力項目に適していないとき、エラーになります。</small></h1><br>	
        	<form name="AddOfferActionForm" class="form-horizontal" action="/gakugeiJob/enterprise/addOffer/" method="POST">
				...
				<label class="col-sm-2 control-label">休日・休暇:</label>
					<div class="col-sm-3"><input type="text" class="form-control" name="holiday" maxlength="100" placeholder="100文字以内"> </div>
				</div>
				
				<div class="form-group">
				<label class="col-sm-2 control-label">勤務時間:</label>
					<div class="col-sm-3"><input type="text" class="form-control" name="workingTime" maxlength="100" placeholder="100文字以内"> </div>
				</div>
				
				<div class="form-group">
				<label class="col-sm-2 control-label">● 給与情報:</label>
					<div class="col-sm-10"><input type="text" class="form-control" name="salary" maxlength="100" placeholder="100文字以内" required> </div>
				</div>
				...
				<label class="col-sm-2 control-label">ひとこと:</label>
					<div class="col-sm-3"><input type="text" class="form-control" name="oneThing" maxlength="100" placeholder="100文字以内"> </div>
				</div>
