		...
		<form name="editSchoolActionForm" class="form-horizontal" action="/gakugeiJob/school/editSchool/" method="POST">
			...
			<div class="form-group">
				<label class="col-sm-2 control-label">校種:</label>
					<div class="col-sm-3"><input type="text" class="form-control" name="kinds" maxlength="20" value="${school.kinds}" placeholder="20文字以内" required autofocus></div>
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				<label class="col-sm-2 control-label">学校URL:</label>
					<div class="col-sm-3"><input type="text" class="form-control" name="url" maxlength="100" value="${school.url}" placeholder="100文字以内" required autofocus></div>
			</div>
			<div class="form-group">
				<label class="col-sm-2 control-label">ひとこと:</label>
					<div class="col-sm-3"><input type="text" class="form-control" name="oneThing" maxlength="100" value="${school.oneThing}" placeholder="100文字以内" required autofocus></div>
			</div>
