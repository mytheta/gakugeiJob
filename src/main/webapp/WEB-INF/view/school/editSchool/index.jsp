		...
		<form name="editSchoolActionForm" class="form-horizontal" action="/gakugeiJob/school/editSchool/" method="POST">
			...
			<div class="form-group">
				<label class="col-sm-2 control-label">学校名:</label>
					<div class="col-sm-3"><input type="text" class="form-control" name="name" maxlength="50" value="${school.name}" placeholder="50æå­ä»¥å" required autofocus></div>
			</div>
			<div class="form-group">
				<label class="col-sm-2 control-label">学校種:</label>
					<div class="col-sm-3"><input type="text" class="form-control" name="kinds" maxlength="20" value="${school.kinds}" placeholder="20æå­ä»¥å" required autofocus></div>
			</div>
			<div class="form-group">
				<label class="col-sm-2 control-label">電話番号:</label>
					<div class="col-sm-3"><input type="text" class="form-control" name="phoneNumber" maxlength="20" value="${school.phoneNumber}" placeholder="20æå­ä»¥å" required autofocus></div>
				<div class="col-sm-7"><p class="help-block">ハイフン無しで入力してください。</p></div>
			</div>
			<div class="form-group">
				<label class="col-sm-2 control-label">メールアドレス:</label>
					<div class="col-sm-3"><input type="text" class="form-control" name="mailAddress" maxlength="100" value="${school.mailAddress}" placeholder="100æå­ä»¥å" required autofocus></div>
			</div>
			<div class="form-group">
				<label class="col-sm-2 control-label">学校URL:</label>
					<div class="col-sm-3"><input type="text" class="form-control" name="url" maxlength="100" value="${school.url}" placeholder="100æå­ä»¥å" required autofocus></div>
			</div>
			<div class="form-group">
				<label class="col-sm-2 control-label">ひとこと:</label>
					<div class="col-sm-3"><input type="text" class="form-control" name="oneThing" maxlength="100" value="${school.oneThing}" placeholder="100æå­ä»¥å" required autofocus></div>
			</div>
