...
/**
 * The condition-query for in-line of school_aplicant.
 * @author DBFlute(AutoGenerator)
 */
public class SchoolAplicantCIQ extends AbstractBsSchoolAplicantCQ {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected BsSchoolAplicantCQ _myCQ;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public SchoolAplicantCIQ(ConditionQuery childQuery, SqlClause sqlClause
                        , String aliasName, int nestLevel, BsSchoolAplicantCQ myCQ) {
    ...
    protected String xinCB() { return SchoolAplicantCB.class.getName(); }
    protected String xinCQ() { return SchoolAplicantCQ.class.getName(); }
}
