...
/**
 * The condition-query for in-line of enterprise_aplicant.
 * @author DBFlute(AutoGenerator)
 */
public class EnterpriseAplicantCIQ extends AbstractBsEnterpriseAplicantCQ {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected BsEnterpriseAplicantCQ _myCQ;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public EnterpriseAplicantCIQ(ConditionQuery childQuery, SqlClause sqlClause
                        , String aliasName, int nestLevel, BsEnterpriseAplicantCQ myCQ) {
    ...
    protected String xinCB() { return EnterpriseAplicantCB.class.getName(); }
    protected String xinCQ() { return EnterpriseAplicantCQ.class.getName(); }
}
