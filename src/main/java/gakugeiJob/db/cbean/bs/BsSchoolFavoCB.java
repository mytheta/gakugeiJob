...
/**
 * The base condition-bean of school_favo.
 * @author DBFlute(AutoGenerator)
 */
public class BsSchoolFavoCB extends AbstractConditionBean {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected SchoolFavoCQ _conditionQuery;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public BsSchoolFavoCB() {
     ...
     */
    public SchoolFavoCQ query() {
        assertQueryPurpose(); // assert only when user-public query 
        return getConditionQuery();
    }

    public SchoolFavoCQ getConditionQuery() { // public for parameter comment and internal
    ...
    protected SchoolFavoCQ createLocalCQ() {
        return xcreateCQ(null, getSqlClause(), getSqlClause().getBasePointAliasName(), 0);
    }

    protected SchoolFavoCQ xcreateCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        SchoolFavoCQ cq = xnewCQ(childQuery, sqlClause, aliasName, nestLevel);
        cq.xsetBaseCB(this);
        return cq;
    }

    protected SchoolFavoCQ xnewCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        return new SchoolFavoCQ(childQuery, sqlClause, aliasName, nestLevel);
    }
     ...
     * <pre>
     * cb.query().<span style="color: #FD4747">union</span>(new UnionQuery&lt;SchoolFavoCB&gt;() {
     *     public void query(SchoolFavoCB unionCB) {
     ...
     */
    public void union(UnionQuery<SchoolFavoCB> unionQuery) {
        final SchoolFavoCB cb = new SchoolFavoCB();
        cb.xsetupForUnion(this); xsyncUQ(cb); unionQuery.query(cb); xsaveUCB(cb);
        final SchoolFavoCQ cq = cb.query(); query().xsetUnionQuery(cq);
    }
     ...
     * because it inherits calls before. (Don't call SetupSelect after here)
     * <pre>
     * cb.query().<span style="color: #FD4747">unionAll</span>(new UnionQuery&lt;SchoolFavoCB&gt;() {
     *     public void query(SchoolFavoCB unionCB) {
     *         unionCB.query().setXxx...
     *     }
     * });
     ...
     */
    public void unionAll(UnionQuery<SchoolFavoCB> unionQuery) {
        final SchoolFavoCB cb = new SchoolFavoCB();
        cb.xsetupForUnion(this); xsyncUQ(cb); unionQuery.query(cb); xsaveUCB(cb);
        final SchoolFavoCQ cq = cb.query(); query().xsetUnionAllQuery(cq);
    }
     ...
     * SchoolFavo schoolFavo = schoolFavoBhv.selectEntityWithDeletedCheck(cb);
     * ... = schoolFavo.<span style="color: #FD4747">getSchoolOffer()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * </pre>
     ...
     * cb.query().setFoo...(value);
     * SchoolFavo schoolFavo = schoolFavoBhv.selectEntityWithDeletedCheck(cb);
     * ... = schoolFavo.<span style="color: #FD4747">getStudent()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * </pre>
     * @return The set-upper of nested relation. {setupSelect...().with[nested-relation]} (NotNull)
     */
    ...
    public HpSpecification specify() {
        ...
        if (_specification == null) { _specification = new HpSpecification(this
            , new HpSpQyCall<SchoolFavoCQ>() {
                public boolean has() { return true; }
                public SchoolFavoCQ qy() { return getConditionQuery(); }
            }
    ...
    public static class HpSpecification extends HpAbstractSpecification<SchoolFavoCQ> {
        protected SchoolOfferCB.HpSpecification _schoolOffer;
        protected StudentCB.HpSpecification _student;
        public HpSpecification(ConditionBean baseCB, HpSpQyCall<SchoolFavoCQ> qyCall
        ...
        @Override
        protected String getTableDbName() { return "school_favo"; }
        /**
     ...
     * cb.<span style="color: #FD4747">columnQuery</span>(new SpecifyQuery&lt;SchoolFavoCB&gt;() {
     *     public void query(SchoolFavoCB cb) {
     *         cb.specify().<span style="color: #FD4747">columnFoo()</span>; <span style="color: #3F7E5E">// left column</span>
     *     }
     * }).lessThan(new SpecifyQuery&lt;SchoolFavoCB&gt;() {
     *     public void query(SchoolFavoCB cb) {
     ...
     */
    public HpColQyOperand<SchoolFavoCB> columnQuery(final SpecifyQuery<SchoolFavoCB> leftSpecifyQuery) {
        return new HpColQyOperand<SchoolFavoCB>(new HpColQyHandler<SchoolFavoCB>() {
            public HpCalculator handle(SpecifyQuery<SchoolFavoCB> rightSp, String operand) {
                return xcolqy(xcreateColumnQueryCB(), xcreateColumnQueryCB(), leftSpecifyQuery, rightSp, operand);
            }
        });
    }

    protected SchoolFavoCB xcreateColumnQueryCB() {
        SchoolFavoCB cb = new SchoolFavoCB();
        cb.xsetupForColumnQuery((SchoolFavoCB)this);
        return cb;
    }
     ...
     */
    public SchoolFavoCB dreamCruiseCB() {
        SchoolFavoCB cb = new SchoolFavoCB();
        cb.xsetupForDreamCruise((SchoolFavoCB) this);
        return cb;
    }
     ...
     * cb.<span style="color: #FD4747">orScopeQuery</span>(new OrQuery&lt;SchoolFavoCB&gt;() {
     *     public void query(SchoolFavoCB orCB) {
     ...
     */
    public void orScopeQuery(OrQuery<SchoolFavoCB> orQuery) {
        xorSQ((SchoolFavoCB)this, orQuery);
    }
     ...
     *     public void query(SchoolFavoCB orCB) {
     *         orCB.query().setFOO_Equal...
     *         orCB.<span style="color: #FD4747">orScopeQueryAndPart</span>(new AndQuery&lt;SchoolFavoCB&gt;() {
     *             public void query(SchoolFavoCB andCB) {
     *                 andCB.query().setBar_...
     *                 andCB.query().setQux_...
     *             }
     *         });
     ...
     */
    public void orScopeQueryAndPart(AndQuery<SchoolFavoCB> andQuery) {
        xorSQAP((SchoolFavoCB)this, andQuery);
    }
    ...
    protected void xprepareSyncQyCall(ConditionBean mainCB) {
        final SchoolFavoCB cb;
        if (mainCB != null) {
            cb = (SchoolFavoCB)mainCB;
        } else {
            cb = new SchoolFavoCB();
        }
        specify().xsetSyncQyCall(new HpSpQyCall<SchoolFavoCQ>() {
            public boolean has() { return true; }
            public SchoolFavoCQ qy() { return cb.query(); }
        });
    }
    ...
    protected String getConditionBeanClassNameInternally() { return SchoolFavoCB.class.getName(); }
    protected String getConditionQueryClassNameInternally() { return SchoolFavoCQ.class.getName(); }
