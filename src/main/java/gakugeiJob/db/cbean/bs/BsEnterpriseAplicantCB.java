...
/**
 * The base condition-bean of enterprise_aplicant.
 * @author DBFlute(AutoGenerator)
 */
public class BsEnterpriseAplicantCB extends AbstractConditionBean {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected EnterpriseAplicantCQ _conditionQuery;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public BsEnterpriseAplicantCB() {
    ...
    public void acceptPrimaryKey(Integer jobOfferId, Integer studentId) {
        ...
        BsEnterpriseAplicantCB cb = this;
     ...
     */
    public EnterpriseAplicantCQ query() {
        assertQueryPurpose(); // assert only when user-public query 
        return getConditionQuery();
    }

    public EnterpriseAplicantCQ getConditionQuery() { // public for parameter comment and internal
    ...
    protected EnterpriseAplicantCQ createLocalCQ() {
        return xcreateCQ(null, getSqlClause(), getSqlClause().getBasePointAliasName(), 0);
    }

    protected EnterpriseAplicantCQ xcreateCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        EnterpriseAplicantCQ cq = xnewCQ(childQuery, sqlClause, aliasName, nestLevel);
        cq.xsetBaseCB(this);
        return cq;
    }

    protected EnterpriseAplicantCQ xnewCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        return new EnterpriseAplicantCQ(childQuery, sqlClause, aliasName, nestLevel);
    }
     ...
     * <pre>
     * cb.query().<span style="color: #FD4747">union</span>(new UnionQuery&lt;EnterpriseAplicantCB&gt;() {
     *     public void query(EnterpriseAplicantCB unionCB) {
     ...
     */
    public void union(UnionQuery<EnterpriseAplicantCB> unionQuery) {
        final EnterpriseAplicantCB cb = new EnterpriseAplicantCB();
        cb.xsetupForUnion(this); xsyncUQ(cb); unionQuery.query(cb); xsaveUCB(cb);
        final EnterpriseAplicantCQ cq = cb.query(); query().xsetUnionQuery(cq);
    }
     ...
     * because it inherits calls before. (Don't call SetupSelect after here)
     * <pre>
     * cb.query().<span style="color: #FD4747">unionAll</span>(new UnionQuery&lt;EnterpriseAplicantCB&gt;() {
     *     public void query(EnterpriseAplicantCB unionCB) {
     *         unionCB.query().setXxx...
     *     }
     * });
     ...
     */
    public void unionAll(UnionQuery<EnterpriseAplicantCB> unionQuery) {
        final EnterpriseAplicantCB cb = new EnterpriseAplicantCB();
        cb.xsetupForUnion(this); xsyncUQ(cb); unionQuery.query(cb); xsaveUCB(cb);
        final EnterpriseAplicantCQ cq = cb.query(); query().xsetUnionAllQuery(cq);
    }
     ...
     * EnterpriseAplicant enterpriseAplicant = enterpriseAplicantBhv.selectEntityWithDeletedCheck(cb);
     * ... = enterpriseAplicant.<span style="color: #FD4747">getEnterpriseOffer()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * </pre>
     ...
     * cb.query().setFoo...(value);
     * EnterpriseAplicant enterpriseAplicant = enterpriseAplicantBhv.selectEntityWithDeletedCheck(cb);
     * ... = enterpriseAplicant.<span style="color: #FD4747">getStudent()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * </pre>
     * @return The set-upper of nested relation. {setupSelect...().with[nested-relation]} (NotNull)
     */
    ...
    public HpSpecification specify() {
        ...
        if (_specification == null) { _specification = new HpSpecification(this
            , new HpSpQyCall<EnterpriseAplicantCQ>() {
                public boolean has() { return true; }
                public EnterpriseAplicantCQ qy() { return getConditionQuery(); }
            }
    ...
    public static class HpSpecification extends HpAbstractSpecification<EnterpriseAplicantCQ> {
        protected EnterpriseOfferCB.HpSpecification _enterpriseOffer;
        protected StudentCB.HpSpecification _student;
        public HpSpecification(ConditionBean baseCB, HpSpQyCall<EnterpriseAplicantCQ> qyCall
        ...
        @Override
        protected String getTableDbName() { return "enterprise_aplicant"; }
        /**
     ...
     * cb.<span style="color: #FD4747">columnQuery</span>(new SpecifyQuery&lt;EnterpriseAplicantCB&gt;() {
     *     public void query(EnterpriseAplicantCB cb) {
     *         cb.specify().<span style="color: #FD4747">columnFoo()</span>; <span style="color: #3F7E5E">// left column</span>
     *     }
     * }).lessThan(new SpecifyQuery&lt;EnterpriseAplicantCB&gt;() {
     *     public void query(EnterpriseAplicantCB cb) {
     ...
     */
    public HpColQyOperand<EnterpriseAplicantCB> columnQuery(final SpecifyQuery<EnterpriseAplicantCB> leftSpecifyQuery) {
        return new HpColQyOperand<EnterpriseAplicantCB>(new HpColQyHandler<EnterpriseAplicantCB>() {
            public HpCalculator handle(SpecifyQuery<EnterpriseAplicantCB> rightSp, String operand) {
                return xcolqy(xcreateColumnQueryCB(), xcreateColumnQueryCB(), leftSpecifyQuery, rightSp, operand);
            }
        });
    }

    protected EnterpriseAplicantCB xcreateColumnQueryCB() {
        EnterpriseAplicantCB cb = new EnterpriseAplicantCB();
        cb.xsetupForColumnQuery((EnterpriseAplicantCB)this);
        return cb;
    }
     ...
     */
    public EnterpriseAplicantCB dreamCruiseCB() {
        EnterpriseAplicantCB cb = new EnterpriseAplicantCB();
        cb.xsetupForDreamCruise((EnterpriseAplicantCB) this);
        return cb;
    }
     ...
     * cb.<span style="color: #FD4747">orScopeQuery</span>(new OrQuery&lt;EnterpriseAplicantCB&gt;() {
     *     public void query(EnterpriseAplicantCB orCB) {
     ...
     */
    public void orScopeQuery(OrQuery<EnterpriseAplicantCB> orQuery) {
        xorSQ((EnterpriseAplicantCB)this, orQuery);
    }
     ...
     *     public void query(EnterpriseAplicantCB orCB) {
     *         orCB.query().setFOO_Equal...
     *         orCB.<span style="color: #FD4747">orScopeQueryAndPart</span>(new AndQuery&lt;EnterpriseAplicantCB&gt;() {
     *             public void query(EnterpriseAplicantCB andCB) {
     *                 andCB.query().setBar_...
     *                 andCB.query().setQux_...
     *             }
     *         });
     ...
     */
    public void orScopeQueryAndPart(AndQuery<EnterpriseAplicantCB> andQuery) {
        xorSQAP((EnterpriseAplicantCB)this, andQuery);
    }
    ...
    protected void xprepareSyncQyCall(ConditionBean mainCB) {
        final EnterpriseAplicantCB cb;
        if (mainCB != null) {
            cb = (EnterpriseAplicantCB)mainCB;
        } else {
            cb = new EnterpriseAplicantCB();
        }
        specify().xsetSyncQyCall(new HpSpQyCall<EnterpriseAplicantCQ>() {
            public boolean has() { return true; }
            public EnterpriseAplicantCQ qy() { return cb.query(); }
        });
    }
    ...
    protected String getConditionBeanClassNameInternally() { return EnterpriseAplicantCB.class.getName(); }
    protected String getConditionQueryClassNameInternally() { return EnterpriseAplicantCQ.class.getName(); }
