package gakugeiJob.db.allcommon;
...
public class DBMetaInstanceHandler implements DBMetaProvider {
    ...
    static {
        ...
        tmpMap.put("admin", "gakugeiJob.db.bsentity.dbmeta.AdminDbm");
        tmpMap.put("enterprise", "gakugeiJob.db.bsentity.dbmeta.EnterpriseDbm");
        tmpMap.put("enterprise_aplicant", "gakugeiJob.db.bsentity.dbmeta.EnterpriseAplicantDbm");
        tmpMap.put("enterprise_favo", "gakugeiJob.db.bsentity.dbmeta.EnterpriseFavoDbm");
        tmpMap.put("enterprise_offer", "gakugeiJob.db.bsentity.dbmeta.EnterpriseOfferDbm");
        tmpMap.put("login", "gakugeiJob.db.bsentity.dbmeta.LoginDbm");
        tmpMap.put("school", "gakugeiJob.db.bsentity.dbmeta.SchoolDbm");
        tmpMap.put("school_aplicant", "gakugeiJob.db.bsentity.dbmeta.SchoolAplicantDbm");
        tmpMap.put("school_favo", "gakugeiJob.db.bsentity.dbmeta.SchoolFavoDbm");
        tmpMap.put("school_offer", "gakugeiJob.db.bsentity.dbmeta.SchoolOfferDbm");
        tmpMap.put("student", "gakugeiJob.db.bsentity.dbmeta.StudentDbm");
