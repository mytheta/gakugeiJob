...
/**
 * The entity of school_aplicant as TABLE. <br />
 * <pre>
 * [primary-key]
 ...
 */
public abstract class BsSchoolAplicant implements Entity, Serializable, Cloneable {
    ...
    public boolean equals(Object other) {
        if (other == null || !(other instanceof BsSchoolAplicant)) { return false; }
        BsSchoolAplicant otherEntity = (BsSchoolAplicant)other;
     ...
     */
    public SchoolAplicant clone() {
        try {
            return (SchoolAplicant)super.clone();
